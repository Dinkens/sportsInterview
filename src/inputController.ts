...
export class PlayerInput {
    ...
    private _updateFromKeyboard(): void {
        ...
        if ((this.inputMap["ArrowUp"] ||  this.inputMap["w"] ||this.mobileUp) && !this._ui.gamePaused) {
            this.verticalAxis = 1;
        ...
        //left - right movement
        if ((this.inputMap["ArrowLeft"] || this.inputMap["a"] || this.mobileLeft) && !this._ui.gamePaused) {
