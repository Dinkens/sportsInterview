...
export class Player extends TransformNode {
    ...
    //player variables
    public coinsTaken: number = 0; //num coins lit
    public coinIsTaken = false;
    public win: boolean = false; //whether the game is won
    public isDancing: boolean = false; //whether the player is won and climbed on the top
    ...
    constructor(assets, scene: Scene, shadowGenerator: ShadowGenerator, input?: PlayerInput) {
        ...
        this._idle = assets.animationGroups[15];
        this._jump = assets.animationGroups[17];
        this._land = assets.animationGroups[4];
        this._run = assets.animationGroups[21];
        this._dash = assets.animationGroups[9];
        this._dance = assets.animationGroups[7];
    ...
    private _loadSounds(scene: Scene): void {
        ...
        this.pickUpSfx = new Sound("light", "./sounds/Rise03.mp3", scene, function () {
        });
